...
*/
  ...
  var Sa = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
    Ta = (function (a) {
      var b = !1,
        c;
      return function () {
  ...
  var Va = function (a) {
      ...
      return a.replace(Ua, function (d, e) {
        ...
        if (!h) {
          ...
          h = new G(h, Pa);
          if (c.tagName && Sa[c.tagName.toUpperCase()])
            throw Error(
              "goog.dom.safe.setInnerHtml cannot be used to set content of " +
                c.tagName +
                "."
            );
          if (Ta()) for (; c.lastChild; ) c.removeChild(c.lastChild);
          c.innerHTML = Qa(h);
  ...
  W.prototype.initialize = function (a, b) {
    ...
    this.g = a;
    a.invisibleSender ||
      ((a = new PresentationRequest(Cb(this))),
  ...
  var Cb = function (a, b) {
    ...
    var e = b.dialRequest;
    e &&
      ((c = e.appName), (d = e.launchParameter) && !d.match(Eb) && (d = zb(d)));
    var h = [];
    h.push({ appId: b.appId, capabilities: b.capabilities });
    b ||
      sa(a.g.additionalSessionRequests, function (k) {
  ...
  f.ba = function (a) {
    var b = this;
    new PresentationRequest(Cb(this)).reconnect(chrome.cast.bb + a).then(
      function (c) {
        Y(b, c);
      },
      function () {}
  ...
  W.prototype.onMessage = function (a) {
    ...
    if ((b = kb(this.R, a.sequenceNumber)))
